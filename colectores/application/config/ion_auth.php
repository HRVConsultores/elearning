 ...
 */
$config['site_title']           = "AF201409"; 		// Site Title, example.com
$config['admin_email']          = "david.moreno@fao.org"; 	// Admin Email, admin@example.com
...
$config['saltValue']  = 'jpXjk?{UKJ+RYJsdzzN.znYdp2^Iy';
