...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="930" height="370" id="FlashID" title="autoevaluacion1">
  <param name="movie" value="<?php echo base_url().SWF; ?>m01/e01.swf" />
  ...
  <!--[if !IE]>-->
  <object type="application/x-shockwave-flash" data="<?php echo base_url().SWF; ?>m01/e01.swf" width="930" height="370">
    <!--<![endif]-->
    <param name="quality" value="high" />
    <param name="wmode" value="opaque" />
    <param name="swfversion" value="8.0.35.0" />
