...
class Course extends SB_Controller 
{
	...
	function index() 
	{
		...
		$this->data['content'] = $this->load->view('course/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('sc_course'); 
		}
		
		$this->data['id'] = $id;
		$this->data['content'] =  $this->load->view('course/view', $this->data ,true);	  
		$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] = $this->load->view('course/form',$this->data, true );		
	  	$this->load->view('layouts/main', $this->data );
