...
class Enrolment extends SB_Controller 
{

	protected $layout 	= "layouts/main";
	public $module 		= 'enrolment';
	public $per_page	= '10';
	...
	function __construct() {
		...
		$this->model = $this->enrolmentmodel;
	...
	function index() 
	{
		...
		$this->data['content'] = $this->load->view('enrolment/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] =  $this->load->view('enrolment/view', $this->data ,true);	  
		$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] = $this->load->view('enrolment/form',$this->data, true );		
	  	$this->load->view('layouts/main', $this->data );
	...
	function save() {
		...
		if( $this->form_validation->run() )
		{
			...
			{
				redirect( 'enrolment/add/'.$ID,301);
			} else {
				redirect( 'enrolment',301);
			}			
